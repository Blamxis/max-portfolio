...
const projects = [
    ...
    },
    {
        ...
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing ' +
            'elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        stack: [{ name: "Html 5"}, { name: "Css 3"}, { name: "Bootstrap 5"}],
        image: '/assets/work/IceGuardians.png',
        live: '',
        github: ''
    },
    {
        ...
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing ' +
            'elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        stack: [{ name: "Html 5"}, { name: "Css 3"}, { name: "Bootstrap 5"}, { name: "Javascript"}],
        image: '/assets/work/Dice-Game.png',
        live: '',
        github: ''
    },
];
                            ...
                            {projects.map((project, index) => {
                                return (
                                    <SwiperSlide key={index} className="w-full">
                                        <div className="relative w-full h-[460px] md:h-[520px] xs:h-[300px] group flex
                                        justify-center items-center bg-black-50/20"
                                        >
                                            {/* overlay */}
